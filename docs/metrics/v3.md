...
| Name                                               | Type    | Help                                           | Labels |
|----------------------------------------------------|---------|------------------------------------------------|--------|
| `minio_cluster_replication_average_active_workers`        | `gauge` | Average number of active replication workers         |        |
| `minio_cluster_replication_average_queued_bytes`        | `gauge` | Average number of bytes queued for replication since server start         |        |
| `minio_cluster_replication_average_queued_count`        | `gauge` | Average number of objects queued for replication since server start         |        |
| `minio_cluster_replication_average_transfer_rate`        | `gauge` | Average replication transfer rate in bytes/sec         |        |
| `minio_cluster_replication_current_active_workers`        | `gauge` | Total number of active replication workers         |        |
| `minio_cluster_replication_current_transfer_rate`        | `gauge` | Current replication transfer rate in bytes/sec         |        |
| `minio_cluster_replication_last_minute_queued_bytes`        | `gauge` | Number of bytes queued for replication in the last full minute         |        |
| `minio_cluster_replication_last_minute_queued_count`        | `gauge` | Number of objects queued for replication in the last full minute         |        |
| `minio_cluster_replication_max_active_workers`        | `gauge` | Maximum number of active replication workers seen since server start         |        |
| `minio_cluster_replication_max_queued_bytes`        | `gauge` | Maximum number of bytes queued for replication since server start         |        |
| `minio_cluster_replication_max_queued_count`        | `gauge` | Maximum number of objects queued for replication since server start         |        |
| `minio_cluster_replication_max_transfer_rate`        | `gauge` | Maximum replication transfer rate in bytes/sec seen since server start         |        |
| `minio_cluster_replication_recent_backlog_count`        | `gauge` | Total number of objects seen in replication backlog in the last 5 minutes         |        |
